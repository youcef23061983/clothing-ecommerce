...
const Shipping = () => {
  ...
  //   if (name === "phone" || name === "phoneCode") {
  //     // Add null checks before calling formatPhone
  //     const phoneCode = name === "phoneCode" ? value : shipping.phoneCode || "";
  //     const phone = name === "phone" ? value : shipping.phone || "";

  //     updates.fullPhone =
  //       phoneCode && phone ? formatPhone(phoneCode, phone) : "";
  //   }
