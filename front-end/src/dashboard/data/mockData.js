...
export const mockBarData = [
  {
    country: "AD",
    jacket: 137,
    // "jacket dogColor": "hsl(229, 70%, 50%)",
    jeans: 96,
    jeansColor: "hsl(296, 70%, 50%)",
    shirt: 72,
    shirtColor: "hsl(97, 70%, 50%)",
    shoes: 140,
